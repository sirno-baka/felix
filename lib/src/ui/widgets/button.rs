...
impl Widget for Button {
    fn measure(&self, c: Constraints) -> Size<f32> {
        c.clamp(Size { width: self.label.chars().count() as f32 * FONT_W + 24.0, height: FONT_H + 10.0 })
    }
